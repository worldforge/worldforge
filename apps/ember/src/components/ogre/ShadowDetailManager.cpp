...
bool ShadowDetailManager::stepDownShadowCameraLodBias(float step) {
	...
	} else if (mShadowCameraLodBias < step &&
			   mShadowCameraLodBias > mMinShadowCameraLodBias) { //if there is still some positive lod bias left which is smaller than step, set it to the minimum shadow lod
