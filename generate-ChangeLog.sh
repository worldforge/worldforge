...
if [ `cat ${distdir}/ChangeLog | wc -l` = "0" ]; then
	...
	chmod u+w ${distdir}/ChangeLog && git log 6951ccbc623ff06dc9598bef83c3d820f9b51aec..HEAD --stat --name-only --date=short --abbrev-commit > ${distdir}/ChangeLog && cat ${top_srcdir}/ChangeLog-CVS >> ${distdir}/ChangeLog
